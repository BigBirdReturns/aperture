...
```sh
npx --yes github:BigBirdReturns/aperture#v0.4.4
```
...
```sh
npx --yes --package=https://github.com/BigBirdReturns/aperture/releases/download/v0.4.4/bigbirdreturns-aperture-0.4.4.tgz aperture list
```

```sh
npx --yes --package=https://github.com/BigBirdReturns/aperture/releases/download/v0.4.4/bigbirdreturns-aperture-0.4.4.tgz aperture chat "/path/to/answer.json"
```
