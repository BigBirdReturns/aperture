...
These commands describe **Aperture 0.4.4**. `aperture` below is the executable name. When it is not installed globally, place the command after this version-pinned package prefix:

```sh
npx --yes --package=https://github.com/BigBirdReturns/aperture/releases/download/v0.4.4/bigbirdreturns-aperture-0.4.4.tgz aperture --help
```
