...
async function bindCachedModel(plan,ui,deps={}){
  ...
  ui.say('Managed cache: the exact selected artifact is already present. No model-host request or weight transfer is needed; complete hashes are checked again before loading.');
