...
export function validateFabricBenchmarkSpec(spec){
  ...
  if(typeof spec.accelerators?.selector!=='string'||!spec.accelerators.selector)throw new ApertureError('FABRIC_SPEC','An exact accelerator selector is required.');
...
export function fabricPolicyFromSpec(spec){
  ...
  return {
    ...
    deviceName:spec.accelerators.selector,
