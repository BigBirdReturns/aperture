...
export const RECIPE_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    hard: {gpuVendor: 'NVIDIA', gpuCount: 4, homogeneous: true, computeCapabilityMin: 12, perGpuObservedWorkingSetBytes: 82 * GiB},
  ...
  },
  {
    ...
    hard: {gpuVendor: 'NVIDIA', gpuCount: 8, homogeneous: true, perGpuObservedWorkingSetBytes: 60 * GiB},
    reference: {computeCapability: 12, perGpuMemoryBytes: 96 * GiB, contextTokens: null, pcieGeneration: 5, pcieWidth: 16},
    evidenceStatus: 'field-observation',
